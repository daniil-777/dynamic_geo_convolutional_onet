...
class Shapes3dDatasetDVR(data.Dataset):
    ''' 3D Shapes dataset class.
    '''

    def __init__(self, dataset_folder, fields, split=None,
                 categories=None, no_except=True, transform=None,
                 shared_dict={}, n_views=48, cache_fields=False,
        ...
        Args:
            ...
            shared_dict (dict): shared dictionary
        ...
        if split_model_for_images:
            assert(n_views > 0)
            print('You are splitting the models by images. Make sure that you \
                entered the correct number of views.')
