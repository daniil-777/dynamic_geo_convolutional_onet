...
encoder_latent_dict = {
    ...
    'pointnet': encoder_latent.EncoderPointNet,
    'pointnet_conv': encoder_latent.ConvEncoder,
    'pointnet_conv2': encoder_latent.ConvEncoder2,
}
...
decoder_dict = {
    ...
    'cbatchnorm_local': decoder.LocalDecoderCBatchNorm,
    'simple_local': decoder.LocalDecoder,
    'dynamic_simple_local': decoder.DynamicLocalDecoder,
    'simple_local2': decoder.LocalDecoder2,
    'simple_conv': decoder.LocalConvDecoder,
...
class OccupancyNetwork(nn.Module):
    ...
    def infer_z(self, p, occ, c, inputs, **kwargs):
        ...
        if self.encoder_latent is not None:
            mean_z, logstd_z = self.encoder_latent(p, occ, c, inputs=inputs, **kwargs)
        else:
            batch_size = p.size(0)
