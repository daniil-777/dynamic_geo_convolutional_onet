...
class ConvEncoder(nn.Module):
    ...
    def __init__(self, c_dim=128, input_dim=5, **kwargs):
        super().__init__()
        self.conv0 = nn.Conv2d(5, 32, 3, stride=2, padding=1)  # 256
        self.conv1 = nn.Conv2d(32, 64, 3, stride=2, padding=1)  # 128
        self.conv2 = nn.Conv2d(64, 128, 3, stride=2, padding=1)  # 64
        self.conv3 = nn.Conv2d(128, 256, 3, stride=2, padding=1)  # 32
        self.conv4 = nn.Conv2d(256, 512, 3, stride=2, padding=1)  #16
...
class Resnet18(nn.Module):
    ...
    def __init__(self, c_dim, normalize=True, use_linear=True, **kwargs):
        super().__init__()
