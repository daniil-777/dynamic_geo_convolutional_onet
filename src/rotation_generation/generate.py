...
cfg = config.load_config(args.config, '/home/dsvilarkovic/partition600/occupancy_networks/configs/default.yaml')
...
# checkpoint_io.load('/home/dsvilarkovic/partition600/occupancy_networks/out/pointcloud/dpoc/7planes_best.pt')
...
for it, data in enumerate(tqdm(test_loader)):
    ...
    if generate_mesh:
        t0 = time.time()
        # out,_, rotation = generator.generate_mesh(data)
        out,_ = generator.generate_mesh(data)
