...
class PointPlaneResnet(nn.Module):
    ...
    Global shape of the object is characterised by "channels" of planes (PCA)
    For every point we learn params (A,B,C,D) of planes capturing local shape of surounding points
    These params are general (for every point the same params).
    Therefore, we learn "channels" planes describing directions of the shape generally  
    Authors: 
