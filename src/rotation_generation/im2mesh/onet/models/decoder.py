...
def BillinearInterpolation(p, net, C_mat, max_dim, interval, device='cuda'):
    ...
    #C_mat = C_mat.to(device)device = self.deviceB
...
class DecoderCBatchNorm(nn.Module):
    ...
    def __init__(self, dim=3, z_dim=128, c_dim=32,
        ...
        is_cuda = False #TODO: switch to torch.cuda.is_available() instead of False
    ...
    def forward(self, p, z, c, C_mat, **kwargs):
        ...
        c = BillinearInterpolation(p, c, C_mat, max_dim, interval, device = self.device)
