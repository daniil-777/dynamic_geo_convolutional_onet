...
class Trainer(BaseTrainer):
    ...
    def __init__(self, model, optimizer, margin_triplet, device=None, input_type='img',
    ...
    def compute_loss(self, data):
        ...
        triplet_loss_normals = self.triplet_loss_normals(plane_normals, self.margin_triplet) #uncomment in case of triplet loss
